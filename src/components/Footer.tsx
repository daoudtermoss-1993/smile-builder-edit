        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#services" className="text-muted-foreground hover:text-primary transition-colors">{t('services')}</a></li>
              <li><a href="#booking" className="text-muted-foreground hover:text-primary transition-colors">{t('booking')}</a></li>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a 
                ...
                className="w-10 h-10 bg-primary rounded-full flex items-center justify-center hover:bg-vibe-cyan transition-all hover:-translate-y-1 shadow-sm"
              >
