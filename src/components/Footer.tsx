...
export const Footer = () => {
  ...
  return (
    <footer className="relative bg-terminal-dark border-t border-white/5 overflow-hidden">
      ...
      <div className="absolute top-0 left-1/4 w-48 sm:w-72 md:w-96 h-48 sm:h-72 md:h-96 bg-primary/5 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-40 sm:w-60 md:w-80 h-40 sm:h-60 md:h-80 bg-gold/5 rounded-full blur-3xl pointer-events-none" />
      
      <div className="container mx-auto px-4 relative z-10">
        {/* Main Footer Content */}
        <div className="py-10 sm:py-12 md:py-16 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 md:gap-12">
          {/* Brand Column */}
            ...
            >
              ...
              <div className="flex gap-2 sm:gap-3">
                <a 
                  ...
                  className="w-9 h-9 sm:w-11 sm:h-11 bg-white/5 border border-white/10 rounded-lg sm:rounded-xl flex items-center justify-center hover:bg-gold/20 hover:border-gold/30 hover:scale-105 transition-all duration-300 group"
                >
                  <Instagram className="w-4 h-4 sm:w-5 sm:h-5 text-white/70 group-hover:text-gold transition-colors" />
                </a>
                <a 
                  ...
                  className="w-9 h-9 sm:w-11 sm:h-11 bg-white/5 border border-white/10 rounded-lg sm:rounded-xl flex items-center justify-center hover:bg-gold/20 hover:border-gold/30 hover:scale-105 transition-all duration-300 group"
                >
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-white/70 group-hover:text-gold transition-colors" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="col-span-2 sm:col-span-1">
            ...
            >
              <h4 className="text-xs sm:text-sm font-semibold text-gold uppercase tracking-wider mb-4 sm:mb-6">
              ...
              <a
                href="#booking"
                className="inline-flex items-center gap-2 bg-gradient-to-r from-gold to-gold-light text-terminal-dark font-semibold px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm hover:shadow-lg hover:shadow-gold/20 transition-all duration-300 group"
              >
